...
import backSpecial from '../../assets/Others/blackback.png';
                    ...
                    <ScrollView>
                        <View style={orderRow}>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                ...
                                <Text style={{ color: '#203546' }}>ORD001</Text>
                            </View>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                ...
                                <Text style={{ color: '#203546' }}>Pending</Text>
                            </View>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
...
const styles = StyleSheet.create({
    ...
    header: { flex: 1, backgroundColor: '#f7c744', alignItems: 'center', justifyContent: 'flex-start', flexDirection: 'row', paddingHorizontal: 10 },// eslint-disable-line
...
//     render() {
//         return (
//             <View style={{ flex: 1, backgroundColor: '#ce6f62' }}>
//                 <Text>ODERS HISTORY</Text>
//             </View>
//         );
//     }
// }
